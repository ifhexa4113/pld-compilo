...
decl_def_stat : decl_def_stat SYM_COMMA test_var_1 { $1->push_back(new VariableDefinition(new VariableDeclaration($3, ((*$1)[0])->getType()), nullptr)); $$ = $1; }
              ...
              | decl_def_stat SYM_COMMA test_var_3 { $1->push_back(new ArrayDefinition(new ArrayDeclaration($3.name, ((*$1)[0])->getType(), $3.size))); $$ = $1; }
              | decl_def_stat SYM_COMMA test_var_3 OP_ASSIGN SYM_BLOCK_OPEN args SYM_BLOCK_CLOSE { $1->push_back(new ArrayListDefinition(new ArrayDeclaration($3.name, ((*$1)[0])->getType(), $3.size), *$6)); $$ = $1; }
